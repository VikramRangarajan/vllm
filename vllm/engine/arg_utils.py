...
class EngineArgs:
    ...
    per_layer_kv_cache_fake_quant_bits: dict[str, int] = get_field(
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        cache_group.add_argument(
            "--per-layer-kv-cache-fake-quant-bits",
            **cache_kwargs["per_layer_kv_cache_fake_quant_bits"],
        )
        cache_group.add_argument(
    ...
    def create_engine_config(
        ...
        cache_config = CacheConfig(
            ...
            per_layer_kv_cache_fake_quant_bits=self.per_layer_kv_cache_fake_quant_bits,
